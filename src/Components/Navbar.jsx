        ...
        <div className="container">
           <div className="menu flex justify-between">
               ...
               <div className="menu-row flex justify-center items-center gap-10">
                   ...
                   <Link to="#" className="bg-[#F0F7F7] rounded-full w-[50px] h-[50px] flex justify-center items-center"><img  className="w-[23px] h-[28px] " src="public/images/notification.svg" alt="icon" /></Link>
                   <div className="flex items-center">
                       <Link to="#" className=" w-[50px] h-[50px] rounded-full bg-[#F0F7F7] flex justify-center items-center gap-[10px] "> <img className="w-[21px] h-[24px] " src="public/images/user.svg" alt="icon" /></Link>
